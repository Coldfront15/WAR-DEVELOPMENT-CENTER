...
Medical Items Added
 ...
 - Carlisle Dressing, Small == QuikClot
 - Carlisle Dressing, Large == Field Dressing
 - Triangular Bandage == Elastic Dressing
 - Gauze Bandage == Packing Bandage
 - Morphine Syrette == Morphine Autoinjector
 - Atropine Syrette == Epinephrine Autoinjector
 - Ammonia Inhalant (Wake up stable patients.)
 - Sulfa Packet (Anti-coagulant in-game to encourage use)
 - Blood Plasma (cc) == Blood (ml)
 - Surgical Kit == Surgical Kit
 - Tourniquet == Tourniquet
 - Splint == Splint
 - 24-Unit First Aid Kit == Personal Aid Kit
 - Blood Plasma (250/500CC)
 - Blood (250/500CC)
